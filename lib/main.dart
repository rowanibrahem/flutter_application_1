...
void main() async {
  ...
  if (locationStatus.isGranted) {
    ...
    // You can show a dialog or take other actions based on permission denial
  }
}
...
Future<void> _startScan(BuildContext context) async {
  ...
  try {
    ...
    kShowSnackBar(context, "Error starting scan: $e");
  }
}
  ...
  if (await _canGetScannedResults(context)) {
    try {
      ...
      kShowSnackBar(context, "Error listening to scan results: $e");
    }
  }
}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Wifi Scan View'),
          actions: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      onPressed: () async => (BuildContext context) async {
                ...
                child: accessPoints.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, i) => ListTile(
                          ...
                          subtitle: Text('Signal strength: ${accessPoints[i].level} dBm'),
                        ),
                      ),
              ),
            ),
